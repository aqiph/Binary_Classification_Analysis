...
path_list = sys.path
module_path = '/Users/hanguo/Documents/Codes/Binary_Classification_Analysis'
...
if __name__ == '__main__':
    ...
    srcDir = 'examples/prediction'
    input_file_target = 'examples/target.csv'
    threshold = 0.5
    output_file = 'predicted_results'
